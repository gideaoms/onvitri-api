...
import DiskMultipartProvider from '@/providers/disk-multipart'
...
const diskMultipartProvider = DiskMultipartProvider()
const photoMapper = PhotoMapper()
const photoService = PhotoService(guardianProvider, diskMultipartProvider)
